...
$dlrm_pt_bin --arch-sparse-feature-size=16 --arch-mlp-bot="13-512-256-64-16" \
...
--round-targets=True --learning-rate=0.1 --mini-batch-size=128 --print-freq=1024 --print-time \
